...
BuildRequires: strusanalyzer-devel >= %{main_version}
BuildRequires: strus >= %{main_version}
BuildRequires: strusanalyzer >= %{main_version}
Requires: strus >= %{main_version}
Requires: strusanalyzer >= %{main_version}
...
%defattr( -, root, root )
%dir %{_libdir}/strus
%{_libdir}/strus/libstrus_module.so.0.1
%{_libdir}/strus/libstrus_module.so.0.1.5
...
%dir %{_includedir}/strus/private
%{_includedir}/strus/private/*.hpp

%changelog
* Fri Mar 20 2015 Patrick Frey <patrickpfrey@yahoo.com> 0.1.5-0.1
- preliminary release
